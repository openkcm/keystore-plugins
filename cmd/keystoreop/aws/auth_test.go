...
import (
	...
	main "github.com/openkcm/keystore-plugins/cmd/keystoreop/aws"
	"github.com/openkcm/keystore-plugins/pkg/common"
	"github.com/openkcm/keystore-plugins/pkg/keystoreop/base"
	awsclient "github.com/openkcm/keystore-plugins/pkg/keystoreop/clients/aws"
...
func TestSecretAuthMethod_GetCredentials(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			authMethod := &main.SecretAuthMethod{}
...
func TestCertificateAuthMethod_GetCredentials(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			wantErr:       true,
			expectedError: main.ErrLoadCert,
		},
		{
			...
			wantErr:       true,
			expectedError: main.ErrLoadPrivateKey,
		},
		{
			...
			wantErr:       true,
			expectedError: main.ErrCreateRolesAnywhereSession,
		},
	}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			authMethod := &main.CertificateAuthMethod{
...
func TestAWSAuthFactory(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.authType, func(t *testing.T) {
			_, err := main.AWSAuthFactory(tt.authType)
			if (err != nil) != tt.wantErr {
