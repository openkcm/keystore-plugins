...
// Plugin implements the KeystoreInstanceKeyOperationServer for AWSPlugin KMS
type Plugin struct {
...
var _ operationsv1.KeystoreInstanceKeyOperationServer = (*Plugin)(nil)

// NewAWSPlugin creates a new AWSPlugin instance
func NewAWSPlugin() *Plugin {
	return &Plugin{
		ClientFactory: NewAWSClient,
	}
}

// Configure configures the plugin
func (ap *Plugin) Configure(
	_ context.Context,
...
func (ap *Plugin) SetLogger(logger hclog.Logger) {
